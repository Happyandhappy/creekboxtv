...
public class PlaybackOverlayFragment extends android.support.v17.leanback.app.PlaybackOverlayFragment
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        List<Movie> movies=MatildaNewsApplication.getHmap().get(mSelectedMovie.getCategory());
        ...
        setOnItemViewSelectedListener(new OnItemViewSelectedListener()
        {
                                       ...
                                       RowPresenter.ViewHolder rowViewHolder, Row row)
            {
                ...
                if( item == null )
                {
                    if( row.toString().startsWith("android.support.v17.leanback.widget.PlaybackControlsRow"))
                    {
                        Log.d("Y.Z.H","PaybackControlsRow!");
    ...
    private void setupRows()
    {
        ...
        Log.d("Y.Z.H","PlaybackOverlayFragment/adapter set in setupRows");
